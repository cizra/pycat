    ...
    for i in range(begin, end, step):
        if i in skills_by_level:
            for skill in skills_by_level[i]:
                ...
                lag += 1
    mud.timers["scholar_write_begin"] = mud.mkdelay(lag, lambda m: mud.send('write book ""'))
    lag += 1
    mud.timers["scholar_write_end"] = mud.mkdelay(lag, lambda m: mud.send('sleep'))
    lag += 1
    mud.timers["scholar_sleep"] = mud.mkdelay(lag + 1, lambda m: mud.send("sleep"))
    return
